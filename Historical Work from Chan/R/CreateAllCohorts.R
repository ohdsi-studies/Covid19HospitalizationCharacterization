...
#
# This file is part of CovidCharacter
#
...
createCohorts <- function(connectionDetails,
    ...
    pathToCsv <- system.file("settings", "NegativeControls.csv", package = "CovidCharacter")
...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
    pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "CovidCharacter")
